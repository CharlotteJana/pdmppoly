...
#   oder matrizen mit ncol = # variables, nrow = length(time)
#t2 documentation: example mit simplePDMP, @return
#t3 auch data.frames für lower, upper zulassen?
#t1 rückgabewert von getSupport anpassen, so dass das Bsp funktioniert
